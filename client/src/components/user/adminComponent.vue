  ...
  <div class="container is-flex is-justify-content-center is-flex-direction-column">
    ...
    <div class="columns is-multiline is-fullwidth">
      ...
      <div class="column is-6">
        <div class="ml-5 mr-5 card">
          <div class="card-header">
            <h4 class="card-header-title title is-4"> Create or edit promotion </h4>
          </div>
          <div class="card-content has-text-centered">
            <div class="select ml-5">
              <select ref="selectorPromotion">
      ...
      <div class="column is-6">
        <div class="ml-5 mr-5 card">
          <div class="card-header">
            <h4 class="card-header-title title is-4">Create or edit pastries </h4>
          </div>
          <div class="card-content has-text-centered">
            <div class="select ml-5">
              <select ref="selector">
                <option>New Pastry</option>
                <option v-for="pastry in pastries" :key="pastry.id">{{ pastry.name }}
                </option>
              </select>
            </div>
          </div>
      ...
      <div class="column is-6">
        <div class="ml-5 mr-5 card">
          <div class="card-header">
            <h4 class="card-header-title title is-4">Create or edit croissanted </h4>
          </div>
          <div class="card-content has-text-centered">
            <div class="select ml-5">
              <select ref="selector">
                <option>New croissanted</option>
                <option v-for="croissant in croissanted" :key="croissant.id">{{ croissant.name }}
                </option>
              </select>
            </div>
          </div>
...
export default {
  ...
  methods: {
    changeStudent(){
      ...
      console.log(this.$refs.selectorStudent.value)
    },
